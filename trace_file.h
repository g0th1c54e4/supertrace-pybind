...
struct MemoryAccessRecord {
	...
	uint64_t acc_address;				// including segment base address
...
struct InstructionRecord {
	...
	*/
	std::unordered_map<size_t, std::pair<uint64_t, uint64_t>> reg_changes;
...
struct TraceData {
	uint64_t ARCHMASK() { return this->arch == TraceDataArch::X86_32 ? 0x00000000FFFFFFFF : 0xFFFFFFFFFFFFFFFF; }
